            ...
            <main role="main" class="col-md-12 px-md-4 pt-4">
                <div class="d-flex justify-content-between align-items-center pb-2 mb-3 border-bottom">
                    ...
                    <form action="{{ route('admin.dashboard') }}" method="GET"
                        class="d-flex flex-grow-1 me-3 position-relative">
                        <input type="text" name="search" class="form-control pe-5" placeholder="Procurar filmes..."
                                ...
                                <tr>
                                    ...
                                    <td class="text-end">
                                        <div class="d-flex justify-content-end gap-1">
                                            <a href="{{ route('admin.movie.show', ['id' => $movie->id]) }}"
